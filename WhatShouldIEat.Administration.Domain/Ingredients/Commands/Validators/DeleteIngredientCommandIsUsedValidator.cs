...
{
	public class DeleteIngredientCommandIsUsedValidator : ICommandValidator<DeleteIngredientCommand>
	{
		private readonly IRecipeRepository _recipeRepository;

		public DeleteIngredientCommandIsUsedValidator(IRecipeRepository recipeRepository) => 
